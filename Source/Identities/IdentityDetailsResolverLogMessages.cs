...
static partial class IdentityDetailsResolverLogMessages
{
    ...
    [LoggerMessage(2, LogLevel.Warning, "Error trying to resolve identity details for {PrincipalId} on tenant {TenantId}: {StatusCode} {ReasonPhrase}")]
    ...
    [LoggerMessage(3, LogLevel.Warning, "Principal {PrincipalId} on tenant {TenantId} is forbidden from accessing the system: '{ReasonPhrase}'")]
