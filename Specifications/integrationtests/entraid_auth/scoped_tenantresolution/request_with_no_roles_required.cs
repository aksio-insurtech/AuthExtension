...
public class request_with_no_roles_required : factory_with_entraid_auth_with_scoped_tenancyresolution
{
    HttpResponseMessage _responseMessage;
    List<LogEntry> _logEntries;

    void Establish() => IngressConfig.EntraIdRoles.NoRoleRequired = true;
