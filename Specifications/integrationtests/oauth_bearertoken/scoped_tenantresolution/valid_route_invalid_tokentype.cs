...
public class valid_route_invalid_tokentype : factory_with_oauth_bearertoken_auth_with_route_tenancyresolution
{
    ...
    async Task Because()
    {
        ...
        requestMessage.Headers.Authorization = new("NonExistantScheme", "dummytoken");
