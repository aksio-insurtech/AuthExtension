...
public class with_two_resolvers_using_the_second : a_sourceidentifier_resolver
{
    Config _config;
    ...
    void Establish()
    {
        _expectedSourceIdentifier = Guid.NewGuid().ToString();
        ...
        _httpContext = GetHttpContext(_expectedSourceIdentifier, "/other/route");
    }
