...
{
    protected static readonly TenantId tenant_id = new TenantId(Guid.Parse("117a700a-f271-49af-a301-5d54cc2a8c9d"));
    ...
    void Establish()
    {
        ...
        augmenter = new(identity_details_resolver.Object, tenant_resolver.Object, bearer_tokens.Object);
        augmenter.ControllerContext = new()
        {
